...
- `test.ps1`: runs .NET tests, republishes that engine, builds/tests the TypeScript server, and checks source preservation in a finally block. MCP tests cannot silently use an older published engine.
