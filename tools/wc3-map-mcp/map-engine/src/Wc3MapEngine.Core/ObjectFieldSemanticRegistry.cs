...
public static class ObjectFieldSemanticRegistry
{
    private static readonly IReadOnlyDictionary<string, ObjectFieldSemanticMetadata> Fields =
        new ReadOnlyDictionary<string, ObjectFieldSemanticMetadata>(new Dictionary<string, ObjectFieldSemanticMetadata>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            , ["aher"] = new("aher", "ability", "Bool", "Hero ability flag", FieldSemanticProvenance.StaticFixtureBacked)
            , ["aite"] = new("aite", "ability", "Bool", "Item ability flag", FieldSemanticProvenance.StaticFixtureBacked)
            , ["aart"] = new("aart", "ability", "String", "Normal icon", FieldSemanticProvenance.StaticFixtureBacked)
            , ["Ncl1"] = new("Ncl1", "ability", "Real", "Channel follow-through time", FieldSemanticProvenance.StaticFixtureBacked)
            , ["Ncl2"] = new("Ncl2", "ability", "Int", "Channel target type", FieldSemanticProvenance.StaticFixtureBacked)
            , ["Ncl3"] = new("Ncl3", "ability", "Int", "Channel options", FieldSemanticProvenance.StaticFixtureBacked)
            , ["Ncl6"] = new("Ncl6", "ability", "String", "Channel base order id", FieldSemanticProvenance.StaticFixtureBacked)
