...
export function mapEngineError(error: { code?: string; message?: string; retryable?: boolean; details?: Record<string, unknown> }): AppError {
  const supported = new Set([
    ...
    "OBJECT_FIELD_UNKNOWN", "OBJECT_FIELD_TYPE_MISMATCH", "OBJECT_FIELD_BASE_MISMATCH",
    "OBJECT_FIELD_SCOPE_INVALID", "OBJECT_FIELD_VALUE_INVALID", "OBJECT_FIELD_DUPLICATE", "OBJECT_HERO_SKILL_INVALID",
