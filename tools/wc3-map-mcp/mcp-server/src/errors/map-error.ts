...
export function mapEngineError(error: { code?: string; message?: string; retryable?: boolean; details?: Record<string, unknown> }): AppError {
  const supported = new Set([
    "INVALID_ARGUMENT", "PATH_OUTSIDE_ROOT", "FILE_NOT_FOUND", "SOURCE_CHANGED", "UNSUPPORTED_COMPONENT",
    ...
    "PLAYER_ID_INVALID", "REGION_NAME_INVALID", "REGION_BOUNDS_INVALID", "REQUIRED_MEMBER_MISSING"
  ]);
