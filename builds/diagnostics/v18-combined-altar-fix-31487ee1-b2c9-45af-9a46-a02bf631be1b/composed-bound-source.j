...
globals
    ...
    fogmodifier array HTW_HeroSelectionFog
    unit array HTW_HeroSelectionPatronByPlayer
...
// MCP function: HTW_HeroSelection_SelectUnitForPlayer (module: systems.hero-selection; systems/hero-selection.j)
